...
<head>
    ...
    <style>
        ...
        /* Sidebar */
        .sidebar { background-color: #1c0568; width: 220px; position: fixed; top: 0; left: 0; height: 100%; overflow-y: auto; z-index: 1030; }
        ...
        nav.topbar { background: linear-gradient(90deg, #19273d 0%, #192030 100%) !important; color: #fff !important; box-shadow: 0 2px 5px rgba(0,0,0,0.2); padding: 0.75rem 1rem; position: sticky; top:0; z-index: 1020; }

        .content-wrapper .container-fluid { padding: 1.5rem; background-color: #f8f9fc; flex-grow: 1; }
